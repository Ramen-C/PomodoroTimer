# Software Requirements Specification (SRS) – Pomodoro Timer Application

## 1. Introduction

### 1.1 Purpose

This Software Requirements Specification (SRS) provides a detailed description of the functional and non-functional requirements for the Pomodoro Timer application. The application aims to help users enhance productivity through task management, timing functions, and progress tracking. The goal of this document is to ensure a mutual understanding of system requirements among the development team and stakeholders.

### 1.2 Document Conventions

This document uses the following terminology:

- **User**: Refers to the end-user of the application.
- **System**: Refers to the Pomodoro Timer application.

### 1.3 Intended Audience

This SRS document is intended for the following audience:

- **Supervising Teacher**: Muhammad Faizan Khan
- **Development Team Members**: All participants involved in the project

### 1.4 Project Overview

The application uses Kotlin for Android front-end development and Spring Boot on the back-end to implement data synchronization and task progress storage. By providing features such as timers, task management, and progress statistics, it helps users manage their time effectively and improve work efficiency.

### 1.5 Contact Information

**Project Leader**:

- Huang Rihui (Student ID: 20222034050)

**Team Members**:

- Ning Kewei (Student ID: 20222034014)
- Zhang Mingkun (Student ID: 20222034075)
- Fang Jinming (Student ID: 20222034071)
- Li Rui (Student ID: 20213503034)
...
本软件需求规格说明书（SRS）详细描述了番茄钟应用程序的功能和非功能需求。该应用旨在通过任务管理、计时功能和进度跟踪，帮助用户提升生产力。此文档的目标是确保开发团队和利益相关者对系统需求达成一致理解。
...
- **指导教师**：Muhammad Faizan Khan
- **开发团队成员**：所有参与项目的成员

### 1.4 项目概述

应用程序使用Kotlin进行Android前端开发，后端使用Spring Boot实现数据同步和任务进度保存。通过提供计时器、任务管理和进度统计等功能，帮助用户有效管理时间，提高工作效率。
